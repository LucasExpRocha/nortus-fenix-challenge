...
export default function SidebarNav({
  ...
  return (
    <aside
      ...
      className={twMerge(
        'flex flex-col justify-between items-center min-w-[82px] h-full bg-[#20273E] pl-10 pr-11 pt-9 pb-20 shadow-[4px_0px_20px_0px_#00000033] rounded-br-4xl fixed z-20',
        className
      )}
    >
